...
export const mockDashboardData: DashboardData = {
  ...
  calendar: (() => {
    ...
    for (let i = 89; i >= 0; i--) {
      ...
      const q = Math.floor(Math.random() * 20);
      const m = q * 3 + Math.floor(Math.random() * 10);
  ...
  quickActions: [
    { id: 'qa1', label: 'Start Interview', description: 'Begin a new AI practice session', iconName: 'FaPlay', href: '/practice', color: 'violet' },
    ...
    { id: 'qa4', label: 'Set Goals', description: 'Track your learning objectives', iconName: 'FaBullseye', href: '/profile', color: 'blue' },
  ],
  monthlyStats: [
