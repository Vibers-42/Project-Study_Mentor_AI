...
import { XPCard, StreakCounter, LevelProgress } from '../../components/gamification';
import { FaStar, FaBullseye, FaPlay, FaExclamationTriangle, FaTrophy, FaArrowRight } from 'react-icons/fa';
import { SlideUp, FadeIn, PageTransition, HoverScale } from '../../components/animations';
                ...
                <div className="space-y-2.5">
                  {dashboard.quickActions.map(action => (
                    <HoverScale key={action.id} scale={1.015}>
                      <button className="w-full flex items-center gap-3 p-3 rounded-xl bg-neutral-800/60 hover:bg-neutral-800 border border-neutral-800 hover:border-violet-500/40 transition-all group text-left cursor-pointer">
